  ...
  return (
    <div className="p-8 min-h-screen bg-[#F8FAFC]">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <h1 className="text-2xl font-bold text-[#1E293B]">Team Members</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative group">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 w-64 transition-all"
            />
          </div>
